<template>
    <svg class="color-wheel" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 650 650" preserveAspectRatio="xMidYMid meet">
        <g class="wheel-maing" transform="translate(325,325)">
            <g data-color="Cyan" id="Cyan" transform="rotate(0)" tabindex="0">
                <g class="polygons">
            ...
            <g data-color="Teal" id="Teal" transform="rotate(18.94736842105263)" tabindex="0">
                <g class="polygons">
            ...
            <g data-color="Green" id="Green" transform="rotate(37.89473684210526)" tabindex="0">
                <g class="polygons">
            ...
            <g data-color="Light Green" id="Light Green" transform="rotate(56.84210526315789)" tabindex="0">
                <g class="polygons">
            ...
            <g data-color="Lime" id="Lime" transform="rotate(75.78947368421052)" tabindex="0">
                <g class="polygons">
            ...
            <g data-color="Yellow" id="Yellow" transform="rotate(94.73684210526315)" tabindex="0">
                <g class="polygons">
            ...
            <g data-color="Amber" id="Amber" transform="rotate(113.68421052631578)" tabindex="0">
                <g class="polygons">
            ...
            <g data-color="Orange" id="Orange" transform="rotate(132.6315789473684)" tabindex="0">
                <g class="polygons">
            ...
            <g data-color="Brown" id="Brown" transform="rotate(151.57894736842104)" tabindex="0">
                <g class="polygons">
            ...
            <g data-color="Blue Grey" id="Blue Grey" transform="rotate(170.52631578947367)" tabindex="0">
                <g class="polygons">
            ...
            <g data-color="Grey" id="Grey" transform="rotate(189.4736842105263)" tabindex="0">
                <g class="polygons">
            ...
            <g data-color="Deep Orange" id="Deep Orange" transform="rotate(208.42105263157893)" tabindex="0">
                <g class="polygons">
            ...
            <g data-color="Red" id="Red" transform="rotate(227.36842105263156)" tabindex="0">
                <g class="polygons">
            ...
            <g data-color="Purple" id="Purple" transform="rotate(265.2631578947368)" tabindex="0">
                <g class="polygons">
            ...
            <g data-color="Deep Purple" id="Deep Purple" transform="rotate(284.2105263157895)" tabindex="0">
                <g class="polygons">
            ...
            <g data-color="Blue" id="Blue" transform="rotate(322.1052631578947)" tabindex="0">
                <g class="polygons">
            ...
            <g data-color="Indigo" id="Indigo" transform="rotate(303.1578947368421)" tabindex="0">
                <g class="polygons">
            ...
            <g data-color="Pink" id="Pink" transform="rotate(246.3157894736842)" tabindex="0">
                <g class="polygons">
